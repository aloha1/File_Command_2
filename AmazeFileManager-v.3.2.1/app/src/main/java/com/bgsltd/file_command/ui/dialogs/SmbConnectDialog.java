...
import com.bgsltd.file_command.utils.EditTextColorStateUtil;
import com.bgsltd.file_command.utils.SimpleTextWatcher;
import com.bgsltd.file_command.utils.SmbUtil;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener {
         ...
         *             See {@link com.bgsltd.file_command.database.UtilsHandler#removeSmbPath(String, String)}
         */

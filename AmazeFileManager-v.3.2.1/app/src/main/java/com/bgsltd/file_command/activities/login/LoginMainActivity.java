package com.bgsltd.file_command.activities.login;
...
public class LoginMainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFacebookAccessTokenTracker = new AccessTokenTracker() {
            ...
            protected void onCurrentAccessTokenChanged(AccessToken oldAccessToken, AccessToken currentAccessToken) {
                ...
                LoginMainActivity.this.onFacebookAccessTokenChange(currentAccessToken);
            }
        };
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    token = GoogleAuthUtil.getToken(LoginMainActivity.this, Plus.AccountApi.getAccountName(mGoogleApiClient), scope);

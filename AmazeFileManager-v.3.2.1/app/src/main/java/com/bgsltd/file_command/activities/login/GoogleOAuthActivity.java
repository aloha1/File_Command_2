    ...
    private void resolveSignInError() {
        if (mGoogleConnectionResult.hasResolution()) {
            try {
                ...
                mGoogleConnectionResult.startResolutionForResult(this, LoginMainActivity.RC_GOOGLE_LOGIN);
    ...
    private void getGoogleOAuthTokenAndLogin() {
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    if (!mGoogleIntentInProgress) {
                        ...
                        startActivityForResult(recover, LoginMainActivity.RC_GOOGLE_LOGIN);
                    }
            ...
            protected void onPostExecute(String token) {
                ...
                setResult(LoginMainActivity.RC_GOOGLE_LOGIN, resultIntent);
                finish();
            }
        };
        task.execute();

...
package com.bgsltd.filecommande.services.asynctasks;
...
public class LoadList extends AsyncTask<String, String, ArrayList<Layoutelements>> {
    ...
    private String path;
    private ICheckShowAdCallback showAdCallback;
    boolean back;
    Main ma;
    Context c;
    int openmode = 0;//0 for normal 1 for smb 2 for custom 3 for drive

    public LoadList(boolean back, Context c, Main ma, int openmode, ICheckShowAdCallback showAdCallback) {
        this.back = back;
        this.ma = ma;
    ...
    protected void onPostExecute(ArrayList<Layoutelements> bitmap) {
        ...
        if(showAdCallback!=null) showAdCallback.onCheckShowAd();

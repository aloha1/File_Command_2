...
package com.bgsltd.filecommande.services;
...
import com.bgsltd.filecommande.RegisterCallback;
...
import com.bgsltd.filecommande.services.FileVerifier.FileVerifierInterface;
...
public class CopyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //going async
        new DoInBackground().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, b);
    ...
    public class DoInBackground extends AsyncTask<Bundle, Void, Integer> {
        ...
        public void onPostExecute(Integer b) {
            ...
            intent.putExtra(Constants.INTENT_TYPE_SHOW_AD, Constants.TYPE_SHOW_AD_CREATE_FOLDER);
    ...
    class Copy {
        ...
        public synchronized void execute(int id, final ArrayList<BaseFile> files, final String FILE2, final boolean move,int mode) {
            if (utils.checkFolder((FILE2), c) == 1) {
                ...
                if (move) {
                    new DeleteTask(getContentResolver(), c).executeOnExecutor(THREAD_POOL_EXECUTOR,toDelete);
                }

...
import com.bgsltd.filecommande.adapters.AppsAdapter;
...
public class HomeFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        c=savedInstanceState.getParcelableArrayList("activity");
    ...
    public void onSaveInstanceState(Bundle b) {
        ...
        if(vl!=null){
        b.putParcelableArrayList("activity",c);

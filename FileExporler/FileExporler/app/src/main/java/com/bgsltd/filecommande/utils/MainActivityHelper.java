...
import com.bgsltd.filecommande.filesystem.Operations;
...
import com.bgsltd.filecommande.services.ExtractService;
import com.bgsltd.filecommande.services.ZipTask;
import com.bgsltd.filecommande.ui.dialogs.SmbSearchDialog;
            ...
            public void done(HFile hFile, final boolean b) {
                ma.getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        toast.cancel();
                        if (b) {
                            ma.updateList(Constants.TYPE_SHOW_AD_CREATE_FOLDER);
                        } else

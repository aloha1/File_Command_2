...
package com.bgsltd.filecommande.fragments;
...
import com.bgsltd.filecommande.activities.MainActivity;
import com.bgsltd.filecommande.adapters.Recycleradapter;
import com.bgsltd.filecommande.callback.ICheckShowAdCallback;
...
import com.bgsltd.filecommande.filesystem.MediaStoreHack;
import com.bgsltd.filecommande.services.asynctasks.LoadList;
import com.bgsltd.filecommande.ui.Layoutelements;
import com.bgsltd.filecommande.ui.icons.IconHolder;
import com.bgsltd.filecommande.ui.icons.IconUtils;
import com.bgsltd.filecommande.ui.icons.Icons;
import com.bgsltd.filecommande.ui.icons.MimeTypes;
import com.bgsltd.filecommande.ui.views.DividerItemDecoration;
import com.bgsltd.filecommande.ui.views.FastScroller;
import com.bgsltd.filecommande.utils.Constants;
import com.bgsltd.filecommande.utils.DataUtils;
import com.bgsltd.filecommande.utils.FileListSorter;
import com.bgsltd.filecommande.utils.Futils;
import com.bgsltd.filecommande.utils.PreferenceUtils;
import com.bgsltd.filecommande.utils.SmbStreamer.Streamer;
...
public class Main extends android.support.v4.app.Fragment implements ICheckShowAdCallback {
    ...
    private int typeShowAdCreateFolder = Constants.TYPE_DEFAULT;
    ...
    public ActionMode.Callback mActionModeCallback = new ActionMode.Callback() {
        ...
        public void initMenu(Menu menu) {
            ...
            menu.findItem(R.id.cpy).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
            menu.findItem(R.id.cut).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.hide:
                    ...
                    updateList(Constants.TYPE_DEFAULT);
                    mode.finish();
                    return true;
                case R.id.ex:
    ...
    private BroadcastReceiver receiverLoadList = new BroadcastReceiver() {

        @Override
        public void onReceive(Context context, Intent intent) {
            int isTypeShowAds = intent.getIntExtra(Constants.INTENT_TYPE_SHOW_AD, Constants.TYPE_DEFAULT);
            updateList(isTypeShowAds);
        }
    };
    ...
    public void loadlist(String path, boolean back, int openMode) {
        ...
        loadList = new LoadList(back, ma.getActivity(), ma, openMode, this);
    ...
    public void updateList(int typeShowAdCreateFolder) {
        this.typeShowAdCreateFolder = typeShowAdCreateFolder;
        computeScroll();
        ic.cleanup();
    ...
    public void onResume() {
        super.onResume();
        try {
            getActivity().registerReceiver(receiverLoadList, new IntentFilter("loadlist"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onPause() {
        ...
        try {
            getActivity().unregisterReceiver(receiverLoadList);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @Override
    public void onCheckShowAd() {
        if (typeShowAdCreateFolder != Constants.TYPE_SHOW_AD_CREATE_FOLDER) return;
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                typeShowAdCreateFolder = Constants.TYPE_DEFAULT;
                if (getActivity() != null)
                    MainActivity.showInterstitial(getActivity());
            }
        }, 1000);
    }
}
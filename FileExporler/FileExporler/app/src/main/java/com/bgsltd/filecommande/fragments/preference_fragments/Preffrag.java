...
package com.bgsltd.filecommande.fragments.preference_fragments;
...
import com.bgsltd.filecommande.BuildConfig;
import com.bgsltd.filecommande.R;
import com.bgsltd.filecommande.ui.views.CheckBx;
...
//                ((com.bgsltd.filecommande.activities.Preferences) getActivity()).donate();
//                return false;
//            }
//        });
        ...
        findPreference("colors").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                ((com.bgsltd.filecommande.activities.Preferences) getActivity()).selectItem(1);
                return true;
            }
        });
        ...
        preference3.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto","bgamingsstudioz@gmail.com", null));
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Feedback : File Command");
...
//         rate
        ...
        preference5.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                intent1.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.bgsltd.filecommande"));
